...
import 'package:expense_advisor/widgets/dialog/account_form.dialog.dart';
import 'package:expense_advisor/widgets/dialog/confirm.modal.dart';
    ...
    return Scaffold(
                          ...
                          onTap: () {
                            WidgetsBinding.instance.addPostFrameCallback((_) {
                              showDialog(
                                context: context,
                                builder:
                                    (builder) => AccountForm(account: account),
                              );
                            });
                          },
                        ),
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () {
          showDialog(
            context: context,
            builder: (builder) => const AccountForm(),
          );
        },
